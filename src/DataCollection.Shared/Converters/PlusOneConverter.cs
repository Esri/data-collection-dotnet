...
{
    /// <summary>
    /// Converter used to add one to a value, primarily intended for use when displaying zero-based index values.
    /// </summary>
    public class PlusOneConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CustomCultureInfo culture)
        {
            ...
            {
                // This looks strange but it is needed to avoid UWP crash.
